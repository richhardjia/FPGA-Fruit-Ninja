...
HD_PWD='C:/Users/richh/sprite_test/sprite_test.runs/game_over_4_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_over_4_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_over_4_rom.tcl
