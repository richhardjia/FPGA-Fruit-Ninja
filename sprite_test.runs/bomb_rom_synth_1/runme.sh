...
HD_PWD='C:/Users/richh/sprite_test/sprite_test.runs/bomb_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bomb_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bomb_rom.tcl
