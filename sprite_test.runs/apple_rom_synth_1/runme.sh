...
HD_PWD='C:/Users/richh/sprite_test/sprite_test.runs/apple_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log apple_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source apple_rom.tcl
